                                  ...
                                  .then(function(snapshot) {
                                   snapshot.forEach(function(childSnapshot) {
                                    ...
                                    if (key == subject_id ) {
                                      ...
                                      $$('.subjectscontents').append('<li class="item-content"><a href="#" onclick="getSubjectData(\''+key+'\')" class="item-link item-content"> <div class="item-inner"><div class="item-title">Subject Name</div><div class="item-after">'+childData.subjectname+'</div></div></a></li>');
